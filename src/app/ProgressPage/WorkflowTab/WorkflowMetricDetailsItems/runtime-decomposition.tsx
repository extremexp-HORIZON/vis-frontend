...
const RuntimeDecomposition = (props: IRuntimeDecomposition) => {
  ...
  useEffect(() => {
    ...
    const [readDataTime, addPaddingTime, splitDataTime] = splitRemainingTime([{}, {}, {}])
    ...
    const data = [
      ...
      },
      {
        task: "Add_Padding",
        start: readDataTime,
        end: readDataTime + addPaddingTime,
      },
      {
        task: "Split_Data",
        start: readDataTime + addPaddingTime,
        end: readDataTime + addPaddingTime + splitDataTime,
      },
      {
        task: "Model_Training",
        start: readDataTime + addPaddingTime + splitDataTime,
        end: totalRuntime,
      },
    ]
