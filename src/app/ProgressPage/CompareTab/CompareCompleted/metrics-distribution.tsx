...
const MetricsDistribution = () => {
  ...
  const generateSpecForMetric = (metric: any) => {
    const filteredData = data.filter(d => d.metricName === metric)
    return {
      width: 300,
      height: 200,
      padding: 5,
          ...
          marks: [
            {
              ...
              encode: {
                enter: {
                  fill: { scale: "color", field: { parent: "metricName" } },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box sx={{ width: "99%", px: 1, display: "flex", justifyContent: "center", height: "100%", flexWrap: "wrap" }}>
        ...
        {selectedMetrics.map(metric => (
            ...
            <Vega
              ...
              spec={generateSpecForMetric(metric)}
              />
        //   </Grid>
        ))}
        {/* </Grid> */}
