...
import { setSelectedTab, setWorkflowsTable, toggleWorkflowSelection, setHoveredWorkflow, setVisibleTable, fetchWorkflowMetrics } from '../../../../store/slices/monitorPageSlice';
