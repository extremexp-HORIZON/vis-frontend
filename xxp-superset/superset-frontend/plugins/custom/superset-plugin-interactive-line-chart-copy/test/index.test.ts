 ...
 * under the License.
 */
import { SupersetPluginInteractiveLineChart } from '../src';
 ...
 */
describe('superset-plugin-interactive-line-chart', () => {
  it('exists', () => {
    expect(SupersetPluginInteractiveLineChart).toBeDefined();
  });
});
