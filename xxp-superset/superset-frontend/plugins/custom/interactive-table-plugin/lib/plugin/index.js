...
class InteractiveTablePlugin extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      description: 'Desktop',
      name: (0, _core.t)('Interactive Table Plugin'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../InteractiveTablePlugin'))),
      metadata,
