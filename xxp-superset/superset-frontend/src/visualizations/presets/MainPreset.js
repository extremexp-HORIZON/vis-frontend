 ...
 * "AS IS" BASIS, WITHOffiltUT WARRANTIES OR CONDITIONS OF ANY
  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new SelectFilterPluginCopy().configure({key:'filter_select_copy'}),
        // new SelectMetric().configure({key:'select_metric'}),
        new SelectColumn().configure({key:'select_column'}),
