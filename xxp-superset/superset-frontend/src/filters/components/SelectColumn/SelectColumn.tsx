...
// //   );
// //   // const timeColumns = (data || [])
// //   // console.log('Timecol',timeColumns);
...
// //     );
// //   }
// //   console.log('formItemData',formItemData);
...
// //   //   },
// //   // );
// //   const metrikiOptionsMapped = metrikiOptions.map(option => ({
// //     label: option,
// //     value: option,
// //   }));
// //   const placeholderText =
// //     metrikiOptionsMapped.length === 0
// //       ? t('No time columns')
// //       : tn('%s option', '%s options', metrikiOptionsMapped.length, metrikiOptionsMapped.length);
// //   console.log('placeholder',placeholderText);
...
//     setDataMask({ ownState: { ...formData.ownState, metriki: newMetriki } });
// //   const placeholderText =
// //     metrikiOptionsMapped.length === 0
// //       ? t('No time columns')
// //       : tn('%s option', '%s options', metrikiOptionsMapped.length, metrikiOptionsMapped.length);
